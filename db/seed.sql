...
VALUES
  ('clip_01', 'user_creator_demo', 'Neon Chase', 'A high-speed chase through neon-lit streets', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/neon-nights/ep01/video.mp4', 'https://images.unsplash.com/photo-1514539079130-25950c84af65?w=400&q=80', 45, 'cseries_neon_nights', 1, 'safe', 'published', 120, 5400, 340, unixepoch() - 86400 * 20),
  ('clip_02', 'user_creator_demo', 'Rooftop Standoff', 'The final confrontation atop Neo Tower', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/neon-nights/ep02/video.mp4', 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?w=400&q=80', 62, 'cseries_neon_nights', 2, 'safe', 'published', 89, 4200, 287, unixepoch() - 86400 * 19),
  ('clip_03', 'user_creator_demo', 'Digital Heartbreak', 'When AI learns about love', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/love-bytes/ep01/video.mp4', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&q=80', 38, 'cseries_love_bytes', 1, 'suggestive', 'published', 210, 8900, 670, unixepoch() - 86400 * 18),
  ('clip_04', 'user_creator_demo', 'Street Fighter', 'Underground martial arts in the slums', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/street-fighter/video.mp4', 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=400&q=80', 55, NULL, NULL, 'safe', 'published', 150, 6700, 420, unixepoch() - 86400 * 17),
  ('clip_05', 'user_creator_demo', 'Midnight Rain', 'A quiet moment in the rain', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/midnight-rain/video.mp4', 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=400&q=80', 30, NULL, NULL, 'safe', 'published', 95, 3800, 250, unixepoch() - 86400 * 16),
  ('clip_06', 'user_creator_demo', 'Code Red', 'Hacking into the mainframe', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/neon-nights/ep03/video.mp4', 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&q=80', 48, 'cseries_neon_nights', 3, 'safe', 'published', 175, 7200, 510, unixepoch() - 86400 * 15),
  ('clip_07', 'user_creator_demo', 'First Date', 'Two strangers meet in virtual reality', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/love-bytes/ep02/video.mp4', 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=400&q=80', 42, 'cseries_love_bytes', 2, 'safe', 'published', 180, 9500, 720, unixepoch() - 86400 * 14),
  ('clip_08', 'user_creator_demo', 'Shadow Dance', 'Mysterious figures in the dark', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/shadow-dance/video.mp4', 'https://images.unsplash.com/photo-1440342359743-84fcb8c21f21?w=400&q=80', 35, NULL, NULL, 'safe', 'published', 110, 4100, 310, unixepoch() - 86400 * 13),
  ('clip_09', 'user_creator_demo', 'Cyber Dreams', 'Dreams become reality in the metaverse', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/neon-nights/ep04/video.mp4', 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80', 50, 'cseries_neon_nights', 4, 'safe', 'published', 200, 8400, 590, unixepoch() - 86400 * 12),
  ('clip_10', 'user_creator_demo', 'Sunset Lovers', 'A bittersweet goodbye at sunset', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/love-bytes/ep03/video.mp4', 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400&q=80', 40, 'cseries_love_bytes', 3, 'suggestive', 'published', 160, 7100, 480, unixepoch() - 86400 * 11),
  ('clip_11', 'user_creator_demo', 'Ghost Protocol', 'When the dead send messages', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/ghost-protocol/video.mp4', 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=400&q=80', 58, NULL, NULL, 'safe', 'published', 130, 5600, 370, unixepoch() - 86400 * 10),
  ('clip_12', 'user_creator_demo', 'Neon Samurai', 'A warrior with a glowing blade', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/neon-nights/ep05/video.mp4', 'https://images.unsplash.com/photo-1518709594023-6eab9bab7b23?w=400&q=80', 65, 'cseries_neon_nights', 5, 'safe', 'published', 220, 10200, 780, unixepoch() - 86400 * 9),
  ('clip_13', 'user_creator_demo', 'Laughing Stock', 'A comedy gone wrong', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/laughing-stock/video.mp4', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=400&q=80', 33, NULL, NULL, 'safe', 'published', 88, 3200, 210, unixepoch() - 86400 * 8),
  ('clip_14', 'user_creator_demo', 'Dark Matter', 'Exploring the void between stars', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/dark-matter/video.mp4', 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=400&q=80', 47, NULL, NULL, 'safe', 'published', 140, 6000, 430, unixepoch() - 86400 * 7),
  ('clip_15', 'user_creator_demo', 'Forbidden Kiss', 'Love that defies all rules', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/love-bytes/ep04/video.mp4', 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=400&q=80', 36, 'cseries_love_bytes', 4, 'nsfw', 'published', 300, 12000, 950, unixepoch() - 86400 * 6),
  ('clip_16', 'user_creator_demo', 'Blade Runner', 'Chasing androids through the rain', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/neon-nights/ep06/video.mp4', 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?w=400&q=80', 52, 'cseries_neon_nights', 6, 'safe', 'published', 190, 8800, 630, unixepoch() - 86400 * 5),
  ('clip_17', 'user_creator_demo', 'Haunted Server', 'The server room has a ghost', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/haunted-server/video.mp4', 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?w=400&q=80', 44, NULL, NULL, 'safe', 'published', 105, 4500, 290, unixepoch() - 86400 * 4),
  ('clip_18', 'user_creator_demo', 'Dragon Awakens', 'The ancient beast rises from slumber', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/clips/dragon-awakens/video.mp4', 'https://images.unsplash.com/photo-1440342359743-84fcb8c21f21?w=400&q=80', 60, NULL, NULL, 'safe', 'published', 250, 11000, 850, unixepoch() - 86400 * 3),
  ('clip_19', 'user_creator_demo', 'Final Goodbye', 'The last message before departure', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/love-bytes/ep05/video.mp4', 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=400&q=80', 28, 'cseries_love_bytes', 5, 'safe', 'published', 170, 7600, 520, unixepoch() - 86400 * 2),
  ('clip_20', 'user_creator_demo', 'Electric Dreams', 'Where reality and fantasy collide', 'https://pub-e8eb9b2155904feeb0e7c5e0712a87e2.r2.dev/series/neon-nights/ep07/video.mp4', 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&q=80', 54, 'cseries_neon_nights', 7, 'safe', 'published', 145, 6300, 440, unixepoch() - 86400 * 1);
